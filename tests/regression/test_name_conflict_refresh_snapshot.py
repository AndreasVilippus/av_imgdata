...
def test_name_conflicts_refresh_uses_snapshot_without_reread():
    ...
    assert "return _snapshot_name_conflicts_mutation_state(" in function_excerpt
    assert "return None, None" not in function_excerpt
