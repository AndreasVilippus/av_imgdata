...
int main() {
    ...
    assert(std::string(av_imgdata::worker::kWorkerVersion) == "0.11.0");
    ...
    assert(runtime::join_path(unc_root, "folder/image.jpg") == "\\\\nas\\photo\\folder\\image.jpg");
#else
