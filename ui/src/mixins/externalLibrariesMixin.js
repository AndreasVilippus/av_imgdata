			...
			return {
				...
				native_processors: {
					...
					IMAGE_PROCESSOR_VIPS: {
						...
						SUPPORTED_FORMATS: ['jpeg', 'jpg', 'png', 'webp', 'tiff', 'heic', 'heif', 'raw', 'dng', 'cr2', 'cr3', 'nef', 'nrw', 'arw', 'orf', 'rw2', 'raf', 'pef'],
			...
			return {
				...
				analysis: {
					...
					CHECKS: {
						...
						RECOGNITION_MIN_FACES_PER_PERSON: Math.max(2, Math.round(this.clampExternalLibrariesNumber(checks.RECOGNITION_MIN_FACES_PER_PERSON, 2, 1000, defaults.analysis.CHECKS.RECOGNITION_MIN_FACES_PER_PERSON))),
						RECOGNITION_MAX_PROFILE_REFERENCE_FACES_PER_PERSON: Math.max(0, Math.round(this.clampExternalLibrariesNumber(checks.RECOGNITION_MAX_PROFILE_REFERENCE_FACES_PER_PERSON, 0, 10000, defaults.analysis.CHECKS.RECOGNITION_MAX_PROFILE_REFERENCE_FACES_PER_PERSON))),
