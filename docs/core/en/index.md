...
ImgData helps you analyze, validate, and maintain photo metadata and face assignments in Synology Photos. Compute-intensive image and face processing can optionally be offloaded to an external worker.

#### Status

Shows the current package state, running operations, and the availability of important components and processing functions.
...
Defines settings for metadata, file and sidecar processing, checks, face recognition, and other package functions.
