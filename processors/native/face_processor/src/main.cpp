...
#ifdef AV_FACE_PROCESSOR_BACKEND_ONNXRUNTIME
#include <jpeglib.h>
...
#ifndef AV_FACE_PROCESSOR_BACKEND_ONNXRUNTIME
...
int run_python_bridge(int argc, char** argv) {
...
#else
    return run_python_bridge(argc, argv);
#endif
}
